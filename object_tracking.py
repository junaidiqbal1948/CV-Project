...
#creating VideoWriter object.The output is stored in 'output.mp4' file.
out = cv2.VideoWriter('./videos/output_video.avi',cv2.VideoWriter_fourcc('M','J','P','G'), 10, (int(frame_width),int(frame_height)))
try:
